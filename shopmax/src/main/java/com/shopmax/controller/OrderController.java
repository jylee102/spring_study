...
public class OrderController {
    ...
    public @ResponseBody ResponseEntity order(
            ...
            // http 통신에서 body에 담겨져서 오므로 반드시 @RequestBody 어노테이션 추가
            @RequestBody @Valid OrderDto orderDto,
            BindingResult bindingResult,
            // Principal: 로그인한 사용자 정보를 가져온다.
            Principal principal) {
        ...
        if (bindingResult.hasErrors()) {
            ...
            // new ResponseEntity<첫번째 매개변수 타입>(response 데이터, response status 코드)
    ...
    // 주문 취소
    @PatchMapping(value = "/order/{orderId}/cancel")
