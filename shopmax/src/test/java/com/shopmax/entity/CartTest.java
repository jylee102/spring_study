...
public class CartTest {
    ...
    public void findCartAndMemberTest() {
        ...
        Cart cart = new Cart(); // insert 할 cart 엔티티 객체

        // Cart 테이블의 member_id 컬럼은 FK 키이므로 Cart 클래스의 member 속성에 member 엔티티를 저장한다.
        ...
        // 영속성 컨텍스트에 엔티티가 없을 경우 JPA는 DB에서 데이터를 select한다.
        // 이때 실제 DB에서 회원 엔티티도 같이 가지고 나오는지 확인하기 위해 영속성 컨텍스트 분리
        //em.clear();
    }
}
